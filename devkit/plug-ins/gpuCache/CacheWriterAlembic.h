...
public:
	...
	const MFileObject& getFileObject() const override;
...
public:
	...
	MaterialGraphWriter(const MaterialGraphWriter&) = delete;
	MaterialGraphWriter& operator=(const MaterialGraphWriter&) = delete;
